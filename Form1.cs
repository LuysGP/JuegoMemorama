...
namespace JuegoMemorama___PracticaFinal
{
    public partial class Form1 : Form
    {
        ...
        public void iniciarJuego()
        {
            ...
            for (var i = 0; i < TamanioColumnasFilas; i++)
            {
                for (var j = 0; j < TamanioColumnasFilas; j++)
                {
                    ...
                    CartasJuego.Image = Properties.Resources.Mario1;
        ...
        private void btnCarta_Click(object sender, EventArgs e)
        {
            ...
            Movimientos++;
            lblContador2.Text = Convert.ToString(Movimientos);
            ...
            CartasSeleccionadas.Add(CartasSeleccionadasUsuario);
                ...
                if(CartasSeleccionadas.Count == 2)
                {
                    ...
                    int Carta1 = Int32.Parse(CartasRevueltas[Int32.Parse(CartaTemporal1.Name) - 1]);
                    int Carta2 = Int32.Parse(CartasRevueltas[Int32.Parse(CartaTemporal2.Name) - 1]);
        ...
        public Bitmap RecuperarImagen(int NumeroImagen)
        {
            ...
            switch (NumeroImagen)
            {
                case 0: TmImg = Properties.Resources.img11;
                    break;
                default: TmImg = (Bitmap)Properties.Resources.ResourceManager.GetObject("img" + NumeroImagen);
                    break;
            }
            return TmImg;
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                CartaTemporal1.Image = Properties.Resources.Mario1;
                CartaTemporal2.Image = Properties.Resources.Mario1;
                CartasSeleccionadas.Clear();
                TiempoVirarCarta = 0;
                timer1.Stop();
            }
